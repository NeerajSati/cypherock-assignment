  ...
  return (
    ...
    <div className='singletransaction'>
        ...
        <div className='transactions'>
            <div className='receive' onClick={()=>showDialogFunc(true)}><img src={receive} alt="receive"></img>RECEIVE</div>
            <div className='send' onClick={()=>showDialogFunc(true)}><img src={send} alt="send"></img>SEND</div>
        </div>
    </div>
    </>
  )
